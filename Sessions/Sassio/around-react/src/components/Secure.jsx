                ...
                <div className="secure-section">
                    <div className="row square all-shadow">
                        ...
                        <span className="col-5 m-1 text-left">
                            ...
                            <p>
                                Get instant insight on what's happening in your business.<br /> It uses a dictionary of the over 200 Latin words,
                            </p>
                        </span>
                    </div>
                    <div className="row square all-shadow">
                        ...
                        <span className="col-5 m-1 text-left">
                            ...
                            <p>
                                Deploy your project in a fraction of a second, no time!<br /> It uses a dictionary of the over 200 Latin words,
                            </p>
                        </span>
                    </div>
                    <div className="row square all-shadow">
                        ...
                        <span className="col-5 m-1 text-left">
                            ...
                            <p>
                                Integrate our solution with other tech leaders in the<br /> industry. It uses a dictionary of the over 200 Latin words,.
                            </p>
                        </span>
                    </div>
                    <div className="row square all-shadow">
